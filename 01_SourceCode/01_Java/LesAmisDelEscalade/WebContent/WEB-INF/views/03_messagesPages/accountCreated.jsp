...
<title><springTags:message code ="accountCreationConfirmation.title"></springTags:message></title>
</head>
<body>
<div class = "messageContainer">
<div class = "messageTitleGood"><springTags:message code ="confirmationTitle.message"></springTags:message></div><br><br>
<div class ="messageBodyCenterAlign"><springTags:message code ="confirmationBody.message"></springTags:message></div><br><br>
