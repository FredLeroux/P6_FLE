package fle.toolBox.controllerTools.listManagement.dataListDisplayerTools.displayer.displayerTools.viewTools;
...
import fle.toolBox.controllerTools.listManagement.dataListDisplayerTools.displayer.displayerTools.dataExtractorTools.CollectionElementsExtrator;
import fle.toolBox.controllerTools.listManagement.dataListDisplayerTools.displayer.displayerTools.dataExtractorTools.ColumnsNamesAndOperators;
import fle.toolBox.controllerTools.listManagement.dataListDisplayerTools.displayer.displayerTools.listManagementTools.ListManagement;
...
public class FrontViewList<O extends Object> {
	...
	public ModelAndView addRequiredObject(ModelAndView frontView, String jspFolderName, String jspName,
			...
			String orderListHandlerName, String editHandlerName,String listName) {
		...
		frontView.addObject("listName", listName);
