...
public class ClimbingSiteModelMgntAndControllerVar {
	...
	protected final String addRouteController = JspJavaScriptStringParser.parse("routes/addSiteRoutes");
	...
	protected final String editRoutePitchsLinkFromRoutePage = "pitchs/displayRoutePitchForm";
